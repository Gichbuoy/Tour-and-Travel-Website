...
const Destination = () => {
  return (
    <div className="destination">
      ...
      <p>
        Tours give you the opportunity to see the world and all it's wonders!
      </p>
      ...
      <DestinationData
        ...
        perculiar environment found on an active volcano, including volcanic
      ...
      <DestinationData
        ...
        through tropical forest, different rock formations and small streams.
        There's a small store halfway up the trail where you can take a break
        and drink Mango juice, and though the summit itself may not have th best view,
        the breeze is fantastic. Once you've made it back down, head straight to the
        beach for a refreshing well-deserved swim"
        img1={Mountain3}
        img2={Mountain4}
      />
    </div>
